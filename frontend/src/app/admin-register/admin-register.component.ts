...
@Component({
  ...
  <form [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-6">
    ...
    <div class="space-y-2">
      ...
      <div class="relative">
        <input
          ...
          [disabled]="isLoading"
          class="w-full px-4 py-3 pl-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 disabled:bg-gray-50 disabled:cursor-not-allowed"
        />
    ...
    <div class="space-y-2">
      ...
      <div *ngIf="form.get('email')?.invalid && form.get('email')?.touched" class="text-sm text-red-600 pl-1">
    ...
    <div class="space-y-2">
      ...
      <div class="relative">
        <input
          ...
          [disabled]="isLoading"
          class="w-full px-4 py-3 pl-12 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 disabled:bg-gray-50 disabled:cursor-not-allowed"
        />
    ...
    <div class="space-y-2">
      ...
      <div class="relative">
        <select
          ...
          [disabled]="isLoading"
          class="w-full px-4 py-3 pl-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 disabled:bg-gray-50 disabled:cursor-not-allowed bg-white"
        >
...
export class AdminRegisterComponent {
  ...
  constructor(private auth: AuthService, private router: Router,
   ...
   onSubmit() {
    ...
    const adminData = this.form.value;
