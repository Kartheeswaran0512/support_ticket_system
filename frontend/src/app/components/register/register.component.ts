          ...
          <div class="p-8">
            <form (ngSubmit)="onRegister()" class="space-y-6">
              ...
              <div class="space-y-2">
                ...
                <div class="relative">
                  ...
                  >
                    <option value="customer">Customer - Submit and track tickets</option>
            ...
            <div class="mt-6 text-center">
              <p class="text-sm text-gray-600">
                ...
                <a routerLink="/login" class="text-green-600 hover:text-green-700 font-medium transition-colors">LogIn</a>
              </p>
            </div>
          </div>
        </div>
